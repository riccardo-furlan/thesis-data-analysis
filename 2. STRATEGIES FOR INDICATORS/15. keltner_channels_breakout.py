...
filename = f"report_{ticker_symbol}_Keltner_{kc_length}-{kc_multiplier}_Breakout_LongOnly.csv"

try:
    with open(filename, 'w', newline='', encoding='utf-8') as f:
        # Write header
        f.write("--- Backtest Summary ---\n")
        f.write(f"Indicator Used: Keltner Channels(length:{kc_length}, multiplier:{kc_multiplier})\n")
    ...
    print(f"Asset: {ticker_symbol} | Strategy: Keltner Channels Breakout (Long Only)")
